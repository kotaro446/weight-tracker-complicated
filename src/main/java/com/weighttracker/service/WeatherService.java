...
public class WeatherService {
    ...
    public String generateHealthAdvice(Map<String, Object> weatherData) {
        ...
        try {
            ...
            // 天気の取得
            Object weatherObj = weatherData.get("weather");
            Map<String, Object> weatherInfo = null;
            if (weatherObj instanceof java.util.List) {
                java.util.List<?> weatherList = (java.util.List<?>) weatherObj;
                if (!weatherList.isEmpty() && weatherList.get(0) instanceof Map) {
                    weatherInfo = (Map<String, Object>) weatherList.get(0);
                }
            }
            String weatherMain = weatherInfo != null ? (String) weatherInfo.get("main") : "";
